...
if __name__ == '__main__':
    ...
    if simular_datos_tiempo_temp:
        ...
        if tipo_equipo == 'tm':
            temperatura, tiempo, tipo_curva = generar_ciclos_termicos(ciclos=45, debug=False, temp_max=45, temp_min=10, tau=0.5)
        else:
            temperatura, tiempo, tipo_curva = generar_ciclos_termicos(ciclos=25, debug=True, temp_max=65)
    ...
    dict_output, dict_figs = simulacion_dinámica_de_agua_en_papel_aceite(tiempo, temperatura,
                                                                         wc_ini,
                                                                         acidez,
                                                                         tipo_equipo, tipo_celulosa, 
                                                                         aromatico)
